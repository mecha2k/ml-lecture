...
#     https://colab.research.google.com/github/PytorchLightning/lightning-tutorials/blob/publication/.notebooks/course_UvA-DL/02-activation-functions.ipynb
#
...
plt.savefig(os.path.join(IMG_PATH, "act_fn.png"), bbox_inches="tight")
...
plt.imshow(img_grid)
plt.axis("off")
plt.savefig(os.path.join(IMG_PATH, "fashion_mnist.png"), bbox_inches="tight")
...
def visualize_gradients(net, color="C0", act_name="none"):
    """Visualize gradients.

    Args:
        net: Object of class BaseNetwork
        color: Color in which we want to visualize the histogram (for easier separation of activation functions)
        act_name: activation function name (for easier separation of)
    """
    net.eval()
...
for i, act_fn_name in enumerate(act_fn_by_name):
    ...
    visualize_gradients(net_actfn, color=f"C{i}", act_name=act_fn_name)
...
def visualize_activations(net, act_name, color="C0"):
    activations = {}
...
"""We see that only a minor amount of neurons is dead, but that they increase with the depth of the layer.
